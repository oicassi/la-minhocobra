...
int main(int argc, char *argv[]) {
    ...
    Sound intro = LoadSound("resources/introTheme.ogg");
    Sound menuTheme = LoadSound("resources/menuTheme.ogg");
    Sound mainTheme;
    Sound gameOverTheme = LoadSound("resources/gameOverTheme.ogg");
    Sound remfila = LoadSound("resources/remHit2.ogg");
    Sound insfila = LoadSound("resources/insHit2.ogg");
    Sound colhit = LoadSound("resources/colHit2.ogg");
    // variáveis
...
// +------------------------------- MENU DO JOGO ---------------------------------+//
    ...
    if (dif == 1) {
        ...
        mainTheme = LoadSound("resources/hardcoreTheme.ogg");
    } else {
        background = LoadTexture("resources/fundoLindo.png");
        mainTheme = LoadSound("resources/mainTheme.ogg");
    }
